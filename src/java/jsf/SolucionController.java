...
public class SolucionController implements Serializable {
    ...
    @EJB
    private jpa.sessions.SolucionFacade ejbFacade;
    ...
    public Solucion getSelected() {
        if (current == null) {
            ...
            selectedItemIndex = -1;
            current.setFechaSolucion(new Date());
        }
        return current;
    }
    ...
    public static class SolucionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Solucion) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Solucion.class.getName());
            }
        }
    }
}
