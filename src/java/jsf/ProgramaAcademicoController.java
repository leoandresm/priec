...
import jpa.sessions.ProgramaAcademicoFacade;
...
public class ProgramaAcademicoController implements Serializable {
    ...
    @EJB
    private jpa.sessions.ProgramaAcademicoFacade ejbFacade;
    ...
    private ProgramaAcademicoFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle").getString("ProgramaAcademicoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle").getString("ProgramaAcademicoUpdated"));
            return "View?faces-redirect=true";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/properties/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle").getString("ProgramaAcademicoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/properties/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class ProgramaAcademicoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ProgramaAcademico) {
                ...
                return getStringKey(o.getIdProgramaAcademico());
            } else {
